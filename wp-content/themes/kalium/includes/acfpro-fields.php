...
<em>Hint: If you want to disable clicking for this item, just type <strong>#</strong> in this field, and select <strong>Redirect to Link URL (Project URL)</strong> value in <strong>Item Linking</strong>.</em>',
		...
		'fields' => array(
			...
			array(
				...
				'layouts' => array(
					...
					'layout_6017f4f4a60f0' => array(
						'key' => 'layout_6017f4f4a60f0',
						'name' => 'video',
						'label' => 'Video',
						'display' => 'row',
						'sub_fields' => array(
							array(
								'key' => 'field_601d63cacda63',
								'label' => 'Video Type',
								'name' => 'video_type',
								'type' => 'select',
								'instructions' => 'Video provider',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								'key' => 'field_6017fa27fc4ff',
								'label' => 'YouTube Video',
								'name' => 'youtube_url',
								'type' => 'oembed',
								'instructions' => 'Alternatively you can insert YouTube video URL',
								'required' => 0,
								'conditional_logic' => array(
									array(
										array(
							...
							array(
								'key' => 'field_6017f5eda60f3',
								'label' => 'Autoplay',
								'name' => 'autoplay',
								'type' => 'true_false',
								'instructions' => 'Play video on slide selection',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								'key' => 'field_60180a26855b7',
								'label' => 'Mute',
								'name' => 'mute',
								'type' => 'true_false',
								'instructions' => 'If "Autoplay" is on, the video will be muted automatically',
								'required' => 0,
								'conditional_logic' => array(
									array(
										array(
											'field' => 'field_6017f5eda60f3',
											'operator' => '!=',
											'value' => '1',
										),
									),
							...
							array(
								'key' => 'field_6017f680a60f5',
								'label' => 'Controls',
								'name' => 'controls',
								'type' => 'true_false',
								'instructions' => 'Show video controls such as play button, volume control and progress bar',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								'key' => 'field_6017f632a60f4',
								'label' => 'Loop',
								'name' => 'loop',
								'type' => 'true_false',
								'instructions' => 'Loop video infinitely',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
							...
							array(
								'key' => 'field_6018105a98ef1',
								'label' => 'Viewport Fit',
								'name' => 'viewport_fit',
								'type' => 'true_false',
								'instructions' => 'Cover video to fit viewport width and height',
								'required' => 0,
								'conditional_logic' => 0,
								'wrapper' => array(
									'width' => '',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5fc75ed114e2b',
		'title' => 'Featured Video',
		'fields' => array(
			array(
				'key' => 'field_5fc760ffc0a20',
				'label' => 'Featured Video',
				'name' => 'featured_video',
				'type' => 'repeater',
				'instructions' => 'Assign self hosted video as featured video of this portfolio item. Adding featured video will replace Featured Image.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'sub_fields' => array(
					array(
						'key' => 'field_5fc765f7c6ad1',
						'label' => 'Video Source',
						'name' => 'src',
						'type' => 'file',
						'instructions' => 'Select MP4, OGG or WEBM file types.',
						'required' => 0,
						'conditional_logic' => 0,
						'wrapper' => array(
							'width' => '',
			...
			array(
				'key' => 'field_60111d98a5e48',
				'label' => 'Autoplay',
				'name' => 'featured_video_autoplay',
				'type' => 'true_false',
				'instructions' => 'If set to autoplay, video will be muted and auto play when visible on viewport.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_60142273e7af8',
				'label' => 'Mute',
				'name' => 'featured_video_mute',
				'type' => 'true_false',
				'instructions' => 'Toggle audio output of the video. If "Autoplay" is on, the video will be muted automatically.',
				'required' => 0,
				'conditional_logic' => array(
					array(
						array(
							'field' => 'field_60111d98a5e48',
							'operator' => '!=',
							'value' => '1',
						),
					),
			...
			array(
				'key' => 'field_60111df4a5e49',
				'label' => 'Controls',
				'name' => 'featured_video_controls',
				'type' => 'true_false',
				'instructions' => 'Show video controls such as play button, volume control and progress bar. If checked, hover layer will not be shown.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
			...
			array(
				'key' => 'field_601131669acfd',
				'label' => 'Loop',
				'name' => 'featured_video_loop',
				'type' => 'true_false',
				'instructions' => 'Loop video infinitely.',
				'required' => 0,
				'conditional_logic' => 0,
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_601ab59cd7063',
				'label' => 'Border Radius',
				'name' => 'breadcrumb_border_radius',
				'type' => 'number',
				'instructions' => 'Set custom border radius (optional).',
				'required' => 0,
				'conditional_logic' => array(
					array(
						array(
			...
			array(
				'key' => 'field_601aba3d483e0',
				'label' => 'Top Margin',
				'name' => 'breadcrumb_margin_top',
				'type' => 'number',
				'instructions' => 'Set custom top margin (optional).',
				'required' => 0,
				'conditional_logic' => array(
					array(
						array(
			...
			array(
				'key' => 'field_601aba7883fd6',
				'label' => 'Bottom Margin',
				'name' => 'breadcrumb_margin_bottom',
				'type' => 'number',
				'instructions' => 'Set custom bottom margin (optional).',
				'required' => 0,
				'conditional_logic' => array(
					array(
						array(
	...
	acf_add_local_field_group(array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_619ba131519d0',
				'label' => 'Show Related Posts',
				'name' => 'related_posts_visibility',
				'type' => 'select',
				'instructions' => 'Show or hide related posts for this post only.',
				'required' => 0,
				'conditional_logic' => 0,
				'wrapper' => array(
					'width' => '',
				...
				'choices' => array(
					'inherit' => 'Inherit from Theme Options',
					'visible' => 'Show Related Products',
					'hidden' => 'Hide Related Products',
				),
				'default_value' => 'inherit',
				'allow_null' => 0,
				'multiple' => 0,
